...
from backend.rest_auth.app_settings import (
    JWTSerializer, TokenSerializer, create_token,
)
from backend.rest_auth.models import TokenModel
from backend.rest_auth.registration.serializers import (
...
from backend.rest_auth.utils import jwt_encode
from backend.rest_auth.views import LoginView
...
class RegisterView(CreateAPIView):
    ...
    throttle_scope = 'backend.rest_auth'
