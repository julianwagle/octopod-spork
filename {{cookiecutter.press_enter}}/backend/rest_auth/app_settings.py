...
from backend.rest_auth.serializers import JWTSerializer as DefaultJWTSerializer
from backend.rest_auth.serializers import (
    JWTSerializerWithExpiration as DefaultJWTSerializerWithExpiration,
)
from backend.rest_auth.serializers import LoginSerializer as DefaultLoginSerializer
from backend.rest_auth.serializers import (
...
from backend.rest_auth.serializers import TokenSerializer as DefaultTokenSerializer
from backend.rest_auth.serializers import (
